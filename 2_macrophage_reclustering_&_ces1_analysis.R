...
# Part 1: As Pelka has insufficent macrophage labels, they will be reclustered
# Part 2: New macrophage subsets will be analsysed for CES1 levels
...
# 13 9 19 15 7 20 17 8 solid DCs/ MKI67
# 16 fcn or spp
# 4 spp or fcn
# 10 fcn or c1qc
# 0, 12 10 6 14 18 # 5 1 2 16 4 # 3 4 10 11 16 macro debateable
