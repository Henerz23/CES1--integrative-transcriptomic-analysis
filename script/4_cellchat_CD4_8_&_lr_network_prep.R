...
get_lri <- function(source, targets) {
  ...
  subsetCommunication(
    ...
    # each subtype counted regardless of size to reflect changes in the different cell phenotypes
    # over the dominant phenotypes
...
# fold change 2 was selected from repetetive exploration of fold values that revealed
# the greatest biolocal separation of results
