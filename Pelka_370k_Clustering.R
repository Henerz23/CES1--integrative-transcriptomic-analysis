...
pbmc@meta.data$CES1_isExpressed <- FetchData(pbmc, vars = "CES1")[,1] > 0
...
pdf(file = "../figures/pbmc_immune_cells_CES1_dotplot.pdf", width = 5, height = 6)
c2 <- DotPlot(pbmc_immune_cells, features = 'CES1', cols = cont_2) + RotatedAxis() + NoLegend() + 
  theme(axis.title.x=element_blank(), axis.title.y=element_blank())
c2
dev.off()
