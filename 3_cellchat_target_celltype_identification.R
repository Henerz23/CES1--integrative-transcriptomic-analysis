...
# to decrease noise, keep only interactions and directions of interest four count and weight
# count 
...
# make figure showing cellchat # remake these to have the correct labels
# png("../figures/SPP1-C1QC_interaction_count_toplevel.png", width = 700, height = 700, res = 150)
netVisual_circle(
  mat.count.out,
...
# png("../figures/SPP1-C1QC_interaction_weight_toplevel.png", width = 700, height = 700, res = 150)
netVisual_circle(
  mat.weight.out,
  vertex.weight = groupSize,
  weight.scale = TRUE,
...
df2 <- subset(pbmc_T, clTopLevel %in% c("TNKILC"))
...
# Compute the communication probability and infer cellular communication network
# increase the nboot for more reliable p-value
...
# interaction counts
# png("../figures/SPP1-C1QC_interaction_count_df2.png", width = 700, height = 700, res = 150)
netVisual_circle(
  mat.count.out,
  vertex.weight = groupSize,
  weight.scale = TRUE,
...
# interaction weights
# png("../figures/SPP1-C1QC_interaction_weight_df2.png", width = 700, height = 700, res = 150)
netVisual_circle(
  mat.weight.out,
  vertex.weight = groupSize,
  weight.scale = TRUE,
